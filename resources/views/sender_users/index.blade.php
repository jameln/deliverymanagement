...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Sender Users</h4>
            </div>
        ...
        @if(count($senderUsersObjects) == 0)
            <div class="panel-body text-center">
                <h4>No Sender Users Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($senderUsersObjects as $senderUsers)
                        <tr>
                            <td>{{ optional($senderUsers->senderCompany)->company_name }}</td>
                            <td>{{ $senderUsers->phone }}</td>
                            <td>{{ $senderUsers->cin }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('sender_users.sender_users.show', $senderUsers->id ) }}" class="btn btn-info" title="Show Sender Users">
