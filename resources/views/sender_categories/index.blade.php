...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Sender Categories</h4>
            </div>
        ...
        @if(count($senderCategories) == 0)
            <div class="panel-body text-center">
                <h4>No Sender Categories Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($senderCategories as $senderCategory)
                        <tr>
                            <td>{{ $senderCategory->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('sender_categories.sender_category.show', $senderCategory->id ) }}" class="btn btn-info" title="Show Sender Category">
